...
def test_cdist_pymoors(benchmark):
    matrix = np.random.rand(5000, 3000)
    result = benchmark(eculidean_distance_plus_time, matrix, matrix)
    assert result.shape == (5000, 3000)
...
@pytest.mark.parametrize("n", [500, 1000, 2000, 2500])
